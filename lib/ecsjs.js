...
/**
 * Get the label associated with a resolver address
 * @param {Object} client - Viem public client
 * @param {string} resolverAddress - The resolver address
 * @returns {Promise<string>} The label (e.g., "name-stars")
 */
export async function getLabelByResolver(client, resolverAddress) {
